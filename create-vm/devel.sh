...
TALOS_NAME='TalosDevopsA'
ROOT_STORAGE="scsi0 ssd-vm:64"
CEPH_STORAGE="scsi1 local-zfs:128"
TALOS_ISO="iso:iso/talos-amd64.iso"
TALOS=\
"771,${TALOS_NAME}Master01,08:00:27:A4:A4:A1,4096,2048,1,c
 772,${TALOS_NAME}Master02,08:00:27:A4:A4:A2,4096,2048,1,c
 773,${TALOS_NAME}Master03,08:00:27:A4:A4:A3,4096,2048,1,c
 781,${TALOS_NAME}Worker01,08:00:27:A4:A4:B1,8192,2048,2,w
 782,${TALOS_NAME}Worker02,08:00:27:A4:A4:B2,8192,2048,2,w
 783,${TALOS_NAME}Worker03,08:00:27:A4:A4:B3,8192,2048,2,w"
