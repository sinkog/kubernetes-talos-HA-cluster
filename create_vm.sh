...
"771,${TALOS_NAME}Master01,08:00:27:A4:A4:A1,8192,2048,1,c,${PROXMOX_MYARRAY[0]}
 772,${TALOS_NAME}Master02,08:00:27:A4:A4:A2,8192,2048,1,c,${PROXMOX_MYARRAY[0]}
 773,${TALOS_NAME}Master03,08:00:27:A4:A4:A3,8192,2048,1,c,${PROXMOX_MYARRAY[0]}
 781,${TALOS_NAME}Worker01,08:00:27:A4:A4:B1,12288,2048,2,w,${PROXMOX_MYARRAY[0]}
 782,${TALOS_NAME}Worker02,08:00:27:A4:A4:B2,12288,2048,2,w,${PROXMOX_MYARRAY[0]}
 783,${TALOS_NAME}Worker03,08:00:27:A4:A4:B3,12288,2048,2,w,${PROXMOX_MYARRAY[0]}"
